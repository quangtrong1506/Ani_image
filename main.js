...
function checkScroll() {
    ...
    if (window.scrollY >= h) {
        if (!a.classList.contains('header-container-2')) a.classList.add('header-container-2');
...
if (document.querySelector('.header .avt .info'))
    document.querySelector('.header .avt .info').addEventListener('mouseleave', function () {
...
if (document.querySelector('.after-login-form .login--btn'))
    document.querySelector('.after-login-form .login--btn').addEventListener('click', function (e) {
        returnForm('login');
    });
...
function returnForm(type) {
    ...
    var registerForm = document.querySelector('.login .login-block .register-form');
    var resetPasswordForm = document.querySelector('.login .login-block .resetPassword-form');
    ...
    if (type == 'register') {
        ...
        document.querySelector('.after-login-form .create-account--btn').style.display = 'none';
        document.querySelector('.after-login-form .login--btn').style.display = 'inline';
        ...
        document.querySelector('.after-login-form .login--btn').style.display = 'none';
        document.querySelector('.after-login-form .create-account--btn').style.display = 'inline';
    }
}
//Todo: slider
//todo
...
if (document.querySelector('.tags-container .tags-element .tags-grid')) {
    ...
    var element = document.querySelector('.tags-container .tags-element .tags-grid div');
    ...
    function scrollTag() {
        ...
        if (x >= element.clientWidth - pos.clientWidth - 10) next.classList.remove('active');
...
if (document.querySelector('.header .end .search--icon')) {
    ...
    icon.addEventListener('click', () => {
        var center = document.querySelector('.header .header-container__nav-inner .center');
        if (center.classList.contains('search-active')) center.classList.remove('search-active');
        else center.classList.add('search-active');
    });
    document
        .querySelector('.header .header-container__nav-inner .center__search i.close--btn')
...
if (document.querySelector('.img-view__main img')) {
    document.querySelector('.img-view__main img').addEventListener('click', (e) => {
        var win = window.open(e.target.src);
    });
}

var input = [5, 4, 1, 2, 3, 4, 5];
var output = input.slice(2, 2 + input[0]);
